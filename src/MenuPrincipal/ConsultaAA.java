...
public class ConsultaAA extends javax.swing.JFrame {
    ...
    private void CargarTabla(){
        ...
        tablaPRODUCTOS.setModel(new javax.swing.table.DefaultTableModel(
            PRODUCTOS,
            new String [] {
                "ID", "COD DE BARRAS", "SERIE", "CATEGORIA", "DESCRIPCION", "$ GENERAL", "$ TECNICO", "U.M", "STOCK"
            }
            ));
    ...
    private void LeerPRODUCTOS(){
        ...
        try{
            ...
            if(res.next())
                PRODUCTOS = new String[res.getInt("COUNT(ID_PROD)")][9];
            ...
            while(res.next())
            {
                ...
                PRODUCTOS[i][8] = String.format("%04d", cero);
                i++;
            }
            CargarTabla();
