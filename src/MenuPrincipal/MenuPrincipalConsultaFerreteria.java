...
import static MenuPrincipal.MenuPrincipalConsultaAA.getConection;
import java.sql.*;
...
public class MenuPrincipalConsultaFerreteria extends javax.swing.JFrame {
    ...
    public MenuPrincipalConsultaFerreteria() {
        initComponents();
    ...
    private void CargarTabla(){
        tablaPRODUCTOS.setModel(new javax.swing.table.DefaultTableModel(
            PRODUCTOS,
            new String [] {
                "CODIGO DE BARRAS", "SERIE", "DESCRIPCION", "$ GENERAL", "$ TECNICO", "U.M", "DIM", "STOCK"
            }
            ));
    ...
    private void LeerPRODUCTOS(){
        ...
        try{
            ...
            ps = con.prepareStatement("SELECT COUNT(ID_PROD) FROM PRODUCTOS WHERE CAT_PROD='FERRETERIA'");
            res = ps.executeQuery();
            
            if(res.next())
                PRODUCTOS = new String[res.getInt("COUNT(ID_PROD)")][8];
            
            ps = con.prepareStatement("SELECT * FROM PRODUCTOS WHERE CAT_PROD='FERRETERIA'");
            res = ps.executeQuery();
    ...
    private void BuscarPRODUCTOS(String buscar){
        ...
        try{
            ...
            ps = con.prepareStatement("SELECT * FROM PRODUCTOS WHERE CODIGO_PROD LIKE '%"+buscar+"%' OR DES_PROD LIKE '%"+buscar+"%' HAVING CAT_PROD='FERRETERIA'");
            res = ps.executeQuery();
            int cero;
            String zero;
            while(res.next())
    ...
    private void initComponents() {
        ...
        jButton_Ferreteria.setEnabled(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MenuPrincipalConsultaFerreteria.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
