...
public class ConsultaReporteDelDiaFerreteria extends javax.swing.JFrame {
    ...
    public ConsultaReporteDelDiaFerreteria() {
        initComponents();
    ...
    */
    ...
    private void initComponents() {
        ...
        jLabel_Ferreteria.setText("FERRETERIA");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsultaReporteDelDiaFerreteria.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
